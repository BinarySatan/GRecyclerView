...
public class HorizontalDividerItemDecoration extends FlexibleDividerDecoration {
    ...
    protected HorizontalDividerItemDecoration(Builder builder, GRecyclerView recyclerView) {
    ...
    protected Rect getDividerBound(int position, RecyclerView parent, View child) {
        ...
        bounds.left = (int) (parent.getPaddingLeft() +
                mMarginProvider.dividerLeftMargin(position, parent) + transitionX);
        bounds.right = (int) (parent.getWidth() - parent.getPaddingRight() -
    ...
    protected void setItemOffsets(Rect outRect, int position, RecyclerView parent) {
        if (mPositionInsideItem) {
            ...
            outRect.set(0, 0, 0, (int) getDividerSize(position, parent));
        }
    }
    ...
    public interface MarginProvider {
         ...
         * @return left margin
         */
        float dividerLeftMargin(int position, RecyclerView parent);
         ...
         * @return right margin
         */
        float dividerRightMargin(int position, RecyclerView parent);
    }
    ...
    public static class Builder extends FlexibleDividerDecoration.Builder<Builder> {
        ...
        private MarginProvider mMarginProvider = new MarginProvider() {
            @Override
            public float dividerLeftMargin(int position, RecyclerView parent) {
                return 0;
            }

            @Override
            public float dividerRightMargin(int position, RecyclerView parent) {
                return 0;
            }
        };
        ...
        public Builder margin(final float leftMargin, final float rightMargin) {
        ...
        public HorizontalDividerItemDecoration build(GRecyclerView recyclerView) {
            checkBuilderParams();
            return new HorizontalDividerItemDecoration(this, recyclerView);
        }
    }
}